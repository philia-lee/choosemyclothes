...
! function (t, i) {
    ...
    function r(s) {
        for (var t = 1; t < arguments.length; t++) {
            ...
            }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(s, Object.getOwnPropertyDescriptors(o)) : e(o).forEach(function (t) {
    ...
    var s = {
        ...
        Y = "keydown",
        q = "load",
        X = t ? "pointerdown" : h ? "touchstart" : "mousedown",
        F = t ? "pointermove" : h ? "touchmove" : "mousemove",
        P = t ? "pointerup pointercancel" : h ? "touchend touchcancel" : "mouseup",
        A = "ready",
        W = "resize",
        j = "show",
        H = "shown",
    ...
    function lt(t, i) {
        t && i && (G(t.length) ? nt(t, function (t) {
            lt(t, i)
    ...
    function mt(t, i) {
        return Q(t[i]) ? t[i] : t.dataset ? t.dataset[i] : t.getAttribute("data-".concat(dt(i)))
    }

    function ft(t, i, e) {
        Q(e) ? t[i] = e : t.dataset ? t.dataset[i] = e : t.setAttribute("data-".concat(dt(i)), e)
    }
    var gt = function () {
        var t = !1;
        if (o) {
    ...
    var yt = a.navigator && /(Macintosh|iPhone|iPod|iPad).*AppleWebKit/i.test(a.navigator.userAgent);

    function xt(t, i) {
        var e = document.createElement("img");
        if (t.naturalWidth && !yt) return i(t.naturalWidth, t.naturalHeight), e;
        var n = document.body || document.documentElement;
        return e.onload = function () {
            i(e.width, e.height), yt || n.removeChild(e)
        }, e.src = t.src, yt || (e.style.cssText = "left:0;max-height:none!important;max-width:none!important;min-height:0!important;min-width:0!important;opacity:0;position:absolute;top:0;z-index:-1;", n.appendChild(e)), e
    }
    ...
    var Dt = {
            ...
            initList: function () {
                var r = this,
                    ...
                    l = this.list,
                    c = [];
                l.innerHTML = "", nt(this.images, function (t, i) {
                    var e = t.src,
                        n = t.alt || function (t) {
                    ...
                    ft(t, "filled", !0), h.loading && ht(i, T), pt(t, q, function (t) {
                        h.loading && lt(i, T), r.loadImage(t)
                    }, {
                        once: !0
                    })
        ...
        Tt = {
            ...
            unbind: function () {
                var t = this.options,
                    ...
                    e = this.canvas,
                    n = this.element.ownerDocument;
                vt(i, O, this.onClick), vt(i, "wheel", this.onWheel, {
                    passive: !1,
                    capture: !0
                }), vt(i, N, this.onDragStart), vt(e, X, this.onPointerDown), vt(n, F, this.onPointerMove), vt(n, P, this.onPointerUp), vt(n, Y, this.onKeyDown), vt(window, W, this.onResize), t.toggleOnDblclick && vt(e, L, this.onDblclick)
            }
        },
        Et = {
            click: function (t) {
            ...
            load: function () {
                ...
                var i = this.element,
                    ...
                    s = this.index,
                    o = this.viewerData;
                lt(n, D), e.loading && lt(this.canvas, T), n.style.cssText = "height:0;" + "margin-left:".concat(o.width / 2, "px;") + "margin-top:".concat(o.height / 2, "px;") + "max-width:none!important;position:absolute;width:0;", this.initImage(function () {
                    ct(n, E, e.movable), ct(n, C, e.transition), t.renderImage(function () {
                        t.viewed = !0, t.viewing = !1, et(e.viewed) && pt(i, B, e.viewed, {
                            once: !0
                        }), wt(i, B, {
            ...
            pointerdown: function (t) {
                ...
                if (!(!this.viewed || this.showing || this.viewing || this.hiding || ("mousedown" === t.type || "pointerdown" === t.type && "mouse" === t.pointerType) && (G(n) && 1 !== n || G(s) && 0 !== s || t.ctrlKey))) {
                    ...
                    var o = !!i.movable && l;
                    1 < Object.keys(e).length ? o = u : "touch" !== t.pointerType && "touchstart" !== t.type || !this.isSwitchable() || (o = c), !i.transition || o !== l && o !== u || lt(this.image, C), this.action = o
                }
            },
            pointermove: function (t) {
                ...
                }) : st(i[t.pointerId || 0] || {}, zt(t, !0)), this.change(t))
            },
        ...
        It = {
            show: function (t) {
                ...
                if (et(n.show) && pt(e, j, n.show, {
                        once: !0
                    }), !1 === wt(e, j) || !this.ready) return this;
                ...
                if (lt(s, k), n.transition && !i) {
                    ...
                    }, ht(s, C), s.offsetWidth, pt(s, V, o, {
                        once: !0
                    }), ht(s, z)
                } else ht(s, z), this.shown();
                return this
            },
            hide: function () {
                ...
                if (e.transition && !t) {
                    ...
                    this.transitioning = {
                        abort: function () {
                            this.viewed ? vt(this.image, V, o) : vt(n, V, s)
                        }
                    }, this.viewed && rt(this.image, C) ? (pt(this.image, V, o, {
                        once: !0
                    }), this.zoomTo(0, !1, !1, !0)) : o()
                } else lt(n, z), this.hidden();
                return this
            },
            view: function (t) {
                var e = this,
                    i = 0 < arguments.length && void 0 !== t ? t : this.options.initialViewIndex;
                ...
                this.image = u, lt(this.items[this.index], f), ht(r, f), this.viewed = !1, this.index = i, this.imageData = {}, ht(u, D), s.loading && ht(a, T), a.innerHTML = "", a.appendChild(u), this.renderList(), o.innerHTML = "";
                ...
                function d() {
                    ...
                    }(et(i) ? i.call(e, u, t) : "".concat(c, " (").concat(t.naturalWidth, " × ").concat(t.naturalHeight, ")"))
                }
                var m;
                return pt(n, B, d, {
                    once: !0
                    ...
                    abort: function () {
                        vt(n, B, d), u.complete ? this.imageRendering ? this.imageRendering.abort() : this.imageInitializing && this.imageInitializing.abort() : (u.src = "", vt(u, q, m), this.timeout && clearTimeout(this.timeout))
                    }
                }, u.complete ? this.load() : (pt(u, q, m = this.load.bind(this), {
                    once: !0
                ...
                if (G(t = Math.max(0, t)) && this.viewed && !this.played && (r || l.zoomable)) {
                    ...
                    if (this.zooming = !0, a) {
                        var T = function (t) {
                            ...
                            E = c && Object.keys(c).length ? function (t) {
                                var n = 0,
                                    s = 0,
                                    o = 0;
                    ...
                    u.width = y, u.height = x, u.ratio = t, this.renderImage(function () {
                        s.zooming = !1, et(l.zoomed) && pt(h, "zoomed", l.zoomed, {
                            once: !0
                        }), wt(h, "zoomed", {
                            ratio: t,
                            oldRatio: D,
            ...
            play: function () {
                ...
                var s = this.options,
                    ...
                    h = 0,
                    l = 0;
                if (this.played = !0, this.onLoadWhenPlay = a, t && this.requestFullscreen(), ht(o, S), nt(this.items, function (t, i) {
                        var e = t.querySelector("img"),
                            n = document.createElement("img");
                        n.src = mt(e, "originalUrl"), n.alt = e.getAttribute("alt"), h += 1, ht(n, b), ct(n, C, s.transition), rt(t, f) && (ht(n, z), l = i), r.push(n), pt(n, q, a, {
                            once: !0
                        }), o.appendChild(n)
                    }), G(s.interval) && 0 < s.interval) {
                    var e = function t() {
                        i.playing = setTimeout(function () {
                            lt(r[l], z), ht(r[l = (l += 1) < h ? l : 0], z), t()
                        }, s.interval)
                    };
                    1 < h && e()
                }
            ...
            stop: function () {
                ...
                }), lt(t, S), t.innerHTML = "", this.exitFullscreen(), this
            },
            full: function () {
                var t = this,
                    i = this.options,
                    ...
                    n = this.image,
                    s = this.list;
                return !this.isShown || this.played || this.fulled || !i.inline || (this.fulled = !0, this.open(), ht(this.button, d), i.transition && (lt(s, C), this.viewed && lt(n, C)), ht(e, y), e.setAttribute("style", ""), at(e, {
                    zIndex: i.zIndex
                }), this.initContainer(), this.viewerData = st({}, this.containerData), this.renderList(), this.viewed && this.initImage(function () {
            ...
            exit: function () {
                var t = this,
                    ...
                    n = this.image,
                    s = this.list;
                return this.isShown && !this.played && this.fulled && i.inline && (this.fulled = !1, this.close(), lt(this.button, d), i.transition && (lt(s, C), this.viewed && lt(n, C)), lt(e, y), at(e, {
            ...
            tooltip: function () {
                var t = this,
                    ...
                    e = this.tooltipBox,
                    n = this.imageData;
                return this.viewed && !this.played && i.tooltip && (e.textContent = "".concat(Math.round(100 * n.ratio), "%"), this.tooltipping ? clearTimeout(this.tooltipping) : i.transition ? (this.fading && wt(e, V), ht(e, S), ht(e, b), ht(e, C), e.offsetWidth, ht(e, z)) : ht(e, S), this.tooltipping = setTimeout(function () {
                    i.transition ? (pt(e, V, function () {
                        lt(e, S), lt(e, b), lt(e, C), t.fading = !1
                    }, {
                        once: !0
                    }), lt(e, z), t.fading = !0) : lt(e, S), t.tooltipping = !1
                }, 1e3)), this
            },
            toggle: function () {
                    ...
                    if (nt(this.items, function (t, i) {
                        ...
                        if (this.length) {
                            if (this.viewed) {
                                ...
                                0 <= n ? (this.viewed = !1, this.view(Math.max(this.index - (n + 1), 0))) : ht(this.items[this.index], f)
                            }
            ...
            destroy: function () {
                var t = this.element,
                    i = this.options;
                return t[p] && (this.destroyed = !0, this.ready ? (this.played && this.stop(), i.inline ? (this.fulled && this.exit(), this.unbind()) : this.isShown ? (this.viewing && (this.imageRendering ? this.imageRendering.abort() : this.imageInitializing && this.imageInitializing.abort()), this.hiding && this.transitioning.abort(), this.hidden()) : this.showing && (this.transitioning.abort(), this.hidden()), this.ready = !1, this.viewer.parentNode.removeChild(this.viewer)) : i.inline && (this.delaying ? this.delaying.abort() : this.initializing && this.initializing.abort()), i.inline || vt(t, O, this.onStart), t[p] = void 0), this
            }
        },
        St = {
            open: function () {
                var t = this.body;
                ht(t, I), t.style.paddingRight = "".concat(this.scrollbarWidth + (parseFloat(this.initialBodyPaddingRight) || 0), "px")
            },
            close: function () {
                var t = this.body;
                lt(t, I), t.style.paddingRight = this.initialBodyPaddingRight
            },
            shown: function () {
                var t = this.element,
                    i = this.options;
                this.fulled = !0, this.isShown = !0, this.render(), this.bind(), this.showing = !1, et(i.shown) && pt(t, H, i.shown, {
                    once: !0
                }), !1 !== wt(t, H) && this.ready && this.isShown && !this.hiding && this.view(this.index)
            },
            hidden: function () {
                var t = this.element,
                    i = this.options;
                this.fulled = !1, this.viewed = !1, this.isShown = !1, this.close(), this.unbind(), ht(this.viewer, k), this.resetList(), this.resetImage(), this.hiding = !1, this.destroyed || (et(i.hidden) && pt(t, M, i.hidden, {
                    once: !0
                }), wt(t, M))
            },
            ...
            return function (t, i, e) {
                    ...
                    if (!t[p]) {
                        ...
                        if (this.body = a, this.scrollbarWidth = window.innerWidth - o.documentElement.clientWidth, this.initialBodyPaddingRight = window.getComputedStyle(a).paddingRight, J(document.createElement(p).style.transition) && (n.transition = !1), n.inline) {
                            ...
                            this.initializing = {
                                ...
                                t.complete ? h() : pt(t, q, h, {
                                    once: !0
                                })
                            })
                        } else pt(t, O, this.onStart = function (t) {
                            var i = t.target;
                ...
                value: function () {
                    if (!this.ready) {
                        ...
                        if (this.parent = i, this.viewer = n, this.title = s, this.toolbar = o, this.navbar = a, this.button = r, this.canvas = l, this.footer = n.querySelector(".".concat(p, "-footer")), this.tooltipBox = n.querySelector(".".concat(p, "-tooltip")), this.player = n.querySelector(".".concat(p, "-player")), this.list = n.querySelector(".".concat(p, "-list")), ht(s, h.title ? kt(Array.isArray(h.title) ? h.title[0] : h.title) : k), ht(a, h.navbar ? kt(h.navbar) : k), ct(r, k, !h.button), h.backdrop && (ht(n, "".concat(p, "-backdrop")), h.inline || "static" === h.backdrop || ft(l, K, "hide")), $(h.className) && h.className && h.className.split(U).forEach(function (t) {
                                ht(n, t)
                            }), h.toolbar) {
                            var c = document.createElement("ul"),
                                ...
                                m = Z.slice(7, 9),
                                f = Z.slice(9);
                            u || ht(o, kt(h.toolbar)), nt(u ? h.toolbar : Z, function (t, i) {
                                var e = u && it(t),
                                    n = u ? dt(i) : t,
                                ...
                                if (s && (h.zoomable || -1 === d.indexOf(n)) && (h.rotatable || -1 === m.indexOf(n)) && (h.scalable || -1 === f.indexOf(n))) {
                                    ...
                                    r.setAttribute("role", "button"), ht(r, "".concat(p, "-").concat(n)), et(a) || ft(r, K, n), G(s) && ht(r, kt(s)), -1 !== ["small", "large"].indexOf(o) ? ht(r, "".concat(p, "-").concat(o)) : "play" === n && ht(r, "".concat(p, "-large")), et(a) && pt(r, O, a), c.appendChild(r)
                                }
                            }), o.appendChild(c)
                        } else ht(o, k);
                        if (!h.rotatable) {
                            var g = o.querySelectorAll('li[class*="rotate"]');
                            ht(g, D), nt(g, function (t) {
                                o.appendChild(t)
                            })
                        }
                        if (h.inline) ht(r, x), at(n, {
                            zIndex: h.zIndexInline
                        }), "static" === window.getComputedStyle(i).position && at(i, {
                            position: "relative"
                        }), i.insertBefore(n, t.nextSibling);
                        else {
                            ht(r, w), ht(n, y), ht(n, b), ht(n, k), at(n, {
                                zIndex: h.zIndex
                            });
                            var v = h.container;
                            $(v) && (v = t.ownerDocument.querySelector(v)), (v = v || this.body).appendChild(n)
                        }
                        h.inline && (this.render(), this.bind(), this.isShown = !0), this.ready = !0, et(h.ready) && pt(t, A, h.ready, {
                            once: !0
                        }), !1 !== wt(t, A) ? this.ready && h.inline && this.view(this.index) : this.ready = !1
                    }
                }
            }], [{
                key: "noConflict",
    ...
    return st(Ot.prototype, Dt, Tt, Et, It, St), Ot
});
